...
export default function LandingCarousel({ settings, heroImages }) {
  ...
  return (
    <div className="h-[300px] md:h-[calc(100vh-70px)] w-full">
      <video
        src={Video}
        controls
        muted
    ...
    // <div className="carousel__slider relative">
    //   <div className="absolute top-[50%] translate-y-[-50%] flex justify-between w-full z-10">
    //     <div
    //       onClick={prev}
    //       className="w-[50px] h-[50px] bg-[#1d1d1d] flex justify-center items-center cursor-pointer hover:bg-[#9a3433]"
    //     >
    //       <svg
    ...
    //             <div className="w-full h-full bg-[#9a3433] opacity-[.50] absolute z-[20] bottom-0 left-0 group-hover:opacity-[1]"></div>
